<template>
    <div class="app">
    	...
    	<div class="user-info">
			...
			<div class="link-item">
				<span>联系电话</span>
				<input type="tel" @input="inputNumber" v-model="mobile" maxlength="11" placeholder="请输入联系电话" />
			</div>
			<div class="link-item">
				<span>身份证号</span>
			...
			<textarea class="addr-detail" @input="inputEmoji(address, 2)" maxlength="40" v-model="address" placeholder="请填写详细地址"></textarea>
    	</div>
